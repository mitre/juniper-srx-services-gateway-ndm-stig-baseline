...
> [!NOTE]
> A security assessment of the Juniper SRX firewall consist of a security review of both the RE and the PFE services functions. The minimum required documents are the Juniper SRX NDM (this profile) and the Juniper SRX ALG  STIGs.
